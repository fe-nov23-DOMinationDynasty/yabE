...
import { ParallaxText } from '@/components/shared/ParallaxText/parallaxText'
	...
	return (
		<div className={styles.page}>
			<main className={styles.main}>
				...
				<ParallaxText baseVelocity={-4}>Make an order</ParallaxText>
				<ParallaxText baseVelocity={4}>Create an order</ParallaxText>
